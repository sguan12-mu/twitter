...
public class TwitterClient extends OAuthBaseClient {
	...
	public void getHomeTimeline(String maxId, JsonHttpResponseHandler handler) {
		...
		// else, max id is null and we get the first 25 tweets
		params.put("count", 25);
	...
	public void replyTweet(String idOfTweetToReplyTo, String tweetContent, JsonHttpResponseHandler handler) {
		String apiUrl = getApiUrl("statuses/update.json");
		// Can specify query string params directly or through RequestParams.
		RequestParams params = new RequestParams();
		params.put("status", tweetContent);
